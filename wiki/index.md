...
EZ-ACCESS (manual + 2 reference sheets + 11 web clippings ingested; `Ramps Handbook.docx` still backlog; pay scales skipped), see `wiki/sources/EZ-ACCESS/`. Manual: Pathway Modular Access System Assembly Manual (P/N 10565, rev 05-12-15) under PATHWAY 3G. Reference sheets (General): EZ Access Parts and Pieces (2018), EZ Access Layout Key and Install Time (2019). Web clippings: these are EZ-ACCESS
